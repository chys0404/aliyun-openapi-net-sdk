...
{
    public class ModifyKnowledgeRequest : RpcAcsRequest<ModifyKnowledgeResponse>
    {
        public ModifyKnowledgeRequest()
            : base("VoiceNavigator", "2018-06-12", "ModifyKnowledge", "voicebot", "openAPI")
        {
        ...
        public override ModifyKnowledgeResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return ModifyKnowledgeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}

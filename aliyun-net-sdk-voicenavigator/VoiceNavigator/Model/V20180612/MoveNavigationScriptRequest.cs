...
{
    public class MoveNavigationScriptRequest : RpcAcsRequest<MoveNavigationScriptResponse>
    {
        public MoveNavigationScriptRequest()
            : base("VoiceNavigator", "2018-06-12", "MoveNavigationScript", "voicebot", "openAPI")
        {
        ...
        public override MoveNavigationScriptResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return MoveNavigationScriptResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}

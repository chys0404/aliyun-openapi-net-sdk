...
{
    public class BatchDeleteNavigationScriptsRequest : RpcAcsRequest<BatchDeleteNavigationScriptsResponse>
    {
        public BatchDeleteNavigationScriptsRequest()
            : base("VoiceNavigator", "2018-06-12", "BatchDeleteNavigationScripts", "voicebot", "openAPI")
        {
        ...
        public override BatchDeleteNavigationScriptsResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return BatchDeleteNavigationScriptsResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
